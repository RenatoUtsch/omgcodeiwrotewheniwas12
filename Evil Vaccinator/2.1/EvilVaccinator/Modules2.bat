...
:scanb
mode con: cols=110 lines=17&color 1F
cls
title EvilVaccinator by LordEvil ^| Custom Fix
echo.
Tools\echox -c 1C -w 110 -e "EVIL VACCINATOR"
echo.
Tools\echox -c 1F -w 180 -e "%evvversion% %programversion%"
Tools\echox -c 1E "=============================================================================================================="
echo.
echo  %progress% [                    ] (0%)
echo.
echo.
Tools\echox -c 1E "컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴"
echo  %scanning2%
