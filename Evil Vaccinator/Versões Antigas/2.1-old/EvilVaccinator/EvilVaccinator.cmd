...
echo.
set /p opcao= (P,E,Q) :        -^> 
if /i "%opcao%"=="P" if /i "%returnto%"=="A" (set language=P& set startfile=func& call Tools\language.bat& "Start.bat"& goto :eof) else (set language=P& set startfile=func& call Tools\language.bat& start EvilUpdater\run.bat& goto :eof)
if /i "%opcao%"=="E" if /i "%returnto%"=="A" (set language=E& set startfile=func& call Tools\language.bat& "Start.bat"& goto :eof) else (set language=E& set startfile=func& call Tools\language.bat& start EvilUpdater\run.bat& goto :eof)
if /i "%opcao%"=="Q" exit
goto menulanguage
